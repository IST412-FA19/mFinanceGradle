...
public class MvcConfiguration implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/personalLoan").setViewName("personalLoan");
        registry.addViewController("/businessLoan").setViewName("businessLoan");
        ...
        registry.addViewController("/loanApproval").setViewName("loanApproval");
        registry.addViewController("/loanSummary").setViewName("loanSummary");
